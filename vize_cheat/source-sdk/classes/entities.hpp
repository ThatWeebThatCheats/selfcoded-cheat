...
public:
	...
	netvar_fn(float_t, throw_time, "DT_BaseCSGrenade->m_fThrowTime");
	...
	bool is_grenade()
	{
		return clientclass()->class_id == chegrenade || clientclass()->class_id == cincendiarygrenade || clientclass()->class_id == cmolotovgrenade || clientclass()->class_id == csmokegrenade || clientclass()->class_id == cflashbang;
	}
};
