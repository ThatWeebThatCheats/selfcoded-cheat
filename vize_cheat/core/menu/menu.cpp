...
menu::menu(void)
{
	m_elements.push_back(new separator(" Ragebot"));

	m_elements.push_back(new boolea(" Antiaim", "msc_antiaim"));

	m_elements.push_back(new combo(" Pitch", "msc_pitch", std::vector<std::string>{ "Off", "Down", "Up" }));
	m_elements.push_back(new combo(" Yaw", "msc_yaw", std::vector<std::string>{ "Off", "Backwards", "Manual" }));

	m_elements.push_back(new separator(" Visuals"));

	m_elements.push_back(new boolea(" Esp", "msc_esp"));
	m_elements.push_back(new boolea(" Name", "msc_names"));

	m_elements.push_back(new boolea(" Radar", "msc_radar"));

	m_elements.push_back(new boolea(" Watermark", "msc_watermark"));

	m_elements.push_back(new boolea(" Viewmodel", "msc_viewmodel"));

	m_elements.push_back(new int_slider(" X", "msc_viewmodel_x", -20, 20));
	m_elements.push_back(new int_slider(" Y", "msc_viewmodel_y", -20, 20));
	m_elements.push_back(new int_slider(" Z", "msc_viewmodel_z", -20, 20));

	m_elements.push_back(new separator(" Misc"));

	m_elements.push_back(new boolea(" Bhop", "msc_bhop"));
	m_elements.push_back(new boolea(" Autostrafer", "msc_autostrafer"));
	m_elements.push_back(new boolea(" Fast Duck", "msc_fastduck"));
